...
export const Route = createFileRoute('/pickseats/$showingId')({
  component: PickSeats
});
...
function PickSeats() {
  ...
  return (
    <section style={styles.header} className="mdl-card mdl-shadow--2dp">
      ...
      <button onClick={() => navigate({ to: "/checkout" })} className="mdl-button mdl-js-button mdl-button--raised mdl-button--colored" style={styles.submitButton} >Check out</button>
    </section>
  )
};
