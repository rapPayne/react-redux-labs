...
export class Register extends Component {
  ...
  changePerson = (e) => {
    switch (e.target.id) {
      case "title":
        store.dispatch({ type: "SET_NAME_TITLE", payload: { title: e.target.value } });
        break;
      case "first_name":
        store.dispatch({ type: "SET_NAME_FIRST", payload: { first: e.target.value } });
        break;
      case "last_name":
        store.dispatch({ type: "SET_NAME_LAST", payload: { last: e.target.value } });
        break;
      case "street":
        store.dispatch({ type: "SET_LOCATION_STREET", payload: { street: e.target.value } });
        break;
      case "city":
        store.dispatch({ type: "SET_LOCATION_CITY", payload: { city: e.target.value } });
        break;
      case "state":
        store.dispatch({ type: "SET_LOCATION_STATE", payload: { state: e.target.value } });
        break;
      case "postcode":
        store.dispatch({ type: "SET_LOCATION_POSTCODE", payload: { postcode: e.target.value } });
        break;
      case "email":
        store.dispatch({ type: "SET_EMAIL", payload: { email: e.target.value } });
        break;
      case "cell":
        store.dispatch({ type: "SET_CELL", payload: { cell: e.target.value } });
        break;
      default:
