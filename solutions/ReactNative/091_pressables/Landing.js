...
export const Landing = ({ films, selected_date, selected_film, show_film_details, showings }) => {
  const dispatch = useDispatch();
  return (
    <SafeAreaView>
      <Modal visible={show_film_details}>
        <FilmDetails film={selected_film} selected_date={selected_date} showings={showings} />
