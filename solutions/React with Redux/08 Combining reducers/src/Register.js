...
export class Register extends Component {
  ...
  changePerson = (e) => {
    switch (e.target.id) {
      case "title":
        store.dispatch(actions.setNameTitle(e.target.value));
        break;
      case "first_name":
      ...
      case "street":
        ...
        break;
      case "city":
        store.dispatch(actions.setLocationCity(e.target.value));
        break;
      case "state":
        store.dispatch(actions.setLocationState(e.target.value));
        break;
      case "postcode":
        store.dispatch(actions.setLocationPostCode(e.target.value));
        break;
      case "email":
