  ...
  changePerson = (e) => {
    switch (e.target.id) {
      case "title":
        break;
      case "first_name":
        store.dispatch({ type: "SET_NAME_FIRST", first: e.target.value })
        break;
      case "last_name":
        break;
      case "street":
        store.dispatch({ type: "SET_LOCATION_STREET", street: e.target.value })
        break;
      case "city":
        break;
      case "state":
      ...
      case "email":
        ...
        break;
      case "cell":
        store.dispatch({ type: "SET_CELL", cell: e.target.value })
        break;
    }
  }
